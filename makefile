...
CONFIG_SRCS=$(CONFIGDIR)/config_validator.c
...
$(TARGET): $(OBJS) $(DB_OBJS) $(UTIL_OBJS) $(CONFIG_OBJS)
	$(CC) $(OBJS) $(DB_OBJS) $(UTIL_OBJS) $(CONFIG_OBJS) -o $(TARGET) $(LIBS)

%.o: %.c
	$(CC) $(CFLAGS) -c $< -o $@

clean:
	rm -f $(OBJS) $(DB_OBJS) $(UTIL_OBJS) $(CONFIG_OBJS) $(TARGET)